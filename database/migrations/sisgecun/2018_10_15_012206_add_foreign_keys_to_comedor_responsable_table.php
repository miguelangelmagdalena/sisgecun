...
class AddForeignKeysToComedorResponsableTable extends Migration {
	...
	public function up()
	{
		Schema::table('comedor_responsable', function(Blueprint $table)
		{
			...
			$table->foreign('users_id', 'fk_comedor_responsable_users1')->references('id')->on('users')->onUpdate('NO ACTION')->onDelete('NO ACTION');
		});
	}
	...
	public function down()
	{
		Schema::table('comedor_responsable', function(Blueprint $table)
		{
			...
			$table->dropForeign('fk_comedor_responsable_users1');
		});
	}
